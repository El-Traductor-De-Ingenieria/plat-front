...
export function SuccessAlert({ title, details, setShowAlert }: Alert) {
  return (
    <div className="mx-5">
      <div className="flex p-4 mb-4 text-sm text-green-700 bg-green-100 rounded-lg dark:bg-green-200 dark:text-green-800" role="alert">
        ...
        <div>
          <span className="font-bold">{title}</span> {details}
        </div>
      </div>
...
export function ErrorAlert({ title, details,setShowAlert }: Alert) {
  return (
    <div className="mx-5">
