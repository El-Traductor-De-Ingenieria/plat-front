                ...
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                        <div className="dark:bg-gray-900 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Para subir un recursos debe rellenar
                                            el siguiente fomulario
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
                                            <input
                                                ...
                                                type="checkbox"
                                                className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>
                                            <label
                            ...
                            <div className="dark:bg-gray-900 bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button
                                    onClick={() => {
                                        console.log(
                                            name,
