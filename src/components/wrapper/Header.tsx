		...
		<header className="sticky top-0 z-40 flex-none mx-auto w-full bg-white md:bg-white/90 dark:bg-slate-900 dark:md:bg-slate-900/90 md:backdrop-blur-sm border-b dark:border-b-0">
			<div className="py-3 px-3 mx-auto w-full md:flex md:justify-between max-w-6xl md:px-4">
				...
				>
					...
					<div className="md:self-center flex items-center mb-4 md:mb-0 collapse collapsed">
						<div className="hidden items-center mr-3 md:flex">
							...
							<div className="relative inline-block text-left ">
								...
								>
									<div
										className="py-1 rounded-md ark:text-gray-300 bg-gray-100 dark:bg-gray-800"
										role="none"
									>
										<a className="flex items-center px-3 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												fill="none"
												viewBox="0 0 24 24"
										...
										<a className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:hover:text-white">
											<svg
												xmlns="http://www.w3.org/2000/svg"
												fill="none"
												viewBox="0 0 24 24"
